      ...
      <div class="col-center my-auto">
        <div class="card">
            <div class="card-header text-center h4">
              <strong>Create A BeardFlow Account</strong> <span><img :src="imgSrc" width="30px"/></span>
            </div>
            <div class="card-body">
                ...
                <div class="form-group text-center">
                  ...
                  <input v-model.trim.lazy="password" type="password" class="form-control form-control-lg" id="inputPass" placeholder="Password">
                    <b-popover
                      ...
                      <template slot="title">Warning! <span class="float-right"><img src="imgSrc" width="20px"/></span></template>
